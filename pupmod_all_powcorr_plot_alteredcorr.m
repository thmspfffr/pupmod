...
print(gcf,'-dpdf',sprintf('~/pupmod/plots/pupmod_all_src_powcorr_drugeffects_lineplots_nostats.pdf'));
%%
...
set(gca,'tickdir','out','xtick',[1 3 5 7 9 11 13],'xticklabel',num2cell([2 4 8 16 32 64 128]))
set(gca,'tickdir','out','ytick',[0 0.25 0.5],'yticklabel',num2cell([0 25 50]))
ylabel('Altered corr. [%]')
title('Rest')
axis([0 14 -0.05 0.55])
...
set(gca,'tickdir','out','ytick',[0 0.25 0.5],'yticklabel',num2cell([0 25 50]))
axis([0 14 -0.05 0.55])
plot(find(outp_dpz.p_res2_p<alpha1),emp_atx.n_p_dpz(find(outp_dpz.p_res2_p<alpha1),1),'ko','markersize',7,'markerfacecolor','k')
plot(find(outp_dpz.p_res2_n<alpha1),emp_atx.n_n_dpz(find(outp_dpz.p_res2_n<alpha1),1),'ko','markersize',7,'markerfacecolor','k')
plot(find(outp_dpz.p_res2_p<alpha2),emp_atx.n_p_dpz(find(outp_dpz.p_res2_p<alpha2),1),'ko','markersize',7,'markerfacecolor','w')
plot(find(outp_dpz.p_res2_n<alpha2),emp_atx.n_n_dpz(find(outp_dpz.p_res2_n<alpha2),1),'ko','markersize',7,'markerfacecolor','w')
plot(find(outp_dpz.p_res2_p<alpha3),emp_atx.n_p_dpz(find(outp_dpz.p_res2_p<alpha3),1),'ko','markersize',7,'markerfacecolor','m')
plot(find(outp_dpz.p_res2_n<alpha3),emp_atx.n_n_dpz(find(outp_dpz.p_res2_n<alpha3),1),'ko','markersize',7,'markerfacecolor','m')
tp_editplots
...
set(gca,'tickdir','out','ytick',[0 0.25 0.5],'yticklabel',num2cell([0 25 50]))
axis([0 14 -0.05 0.55])
plot(find(outp_dpz.p_cnt2_p<alpha1),emp_atx.n_p_dpz(find(outp_dpz.p_cnt2_p<alpha1),2),'ko','markersize',7,'markerfacecolor','k')
plot(find(outp_dpz.p_cnt2_n<alpha1),emp_atx.n_n_dpz(find(outp_dpz.p_cnt2_n<alpha1),2),'ko','markersize',7,'markerfacecolor','k')
plot(find(outp_dpz.p_cnt2_p<alpha2),emp_atx.n_p_dpz(find(outp_dpz.p_cnt2_p<alpha2),2),'ko','markersize',7,'markerfacecolor','w')
plot(find(outp_dpz.p_cnt2_n<alpha2),emp_atx.n_n_dpz(find(outp_dpz.p_cnt2_n<alpha2),2),'ko','markersize',7,'markerfacecolor','w')
plot(find(outp_dpz.p_cnt2_p<alpha3),emp_atx.n_p_dpz(find(outp_dpz.p_cnt2_p<alpha3),2),'ko','markersize',7,'markerfacecolor','m')
plot(find(outp_dpz.p_cnt2_n<alpha3),emp_atx.n_n_dpz(find(outp_dpz.p_cnt2_n<alpha3),2),'ko','markersize',7,'markerfacecolor','m')
tp_editplots
...
set(gca,'tickdir','out','xtick',[1 3 5 7 9 11 13],'xticklabel',num2cell([2 4 8 16 32 64 128]))
xlabel('Carrier frequency [Hz]'); 
plot(find(outp_dpz.p_context2_p<alpha1),emp_atx.n_p_context_dpz(find(outp_dpz.p_context2_p<alpha1)),'ko','markersize',7,'markerfacecolor','k')
plot(find(outp_dpz.p_context2_n<alpha1),emp_atx.n_n_context_dpz(find(outp_dpz.p_context2_n<alpha1)),'ko','markersize',7,'markerfacecolor','k')
plot(find(outp_dpz.p_context2_p<alpha2),emp_atx.n_p_context_dpz(find(outp_dpz.p_context2_p<alpha2)),'ko','markersize',7,'markerfacecolor','w')
plot(find(outp_dpz.p_context2_n<alpha2),emp_atx.n_n_context_dpz(find(outp_dpz.p_context2_n<alpha2)),'ko','markersize',7,'markerfacecolor','w')
plot(find(outp_dpz.p_context2_p<alpha3),emp_atx.n_p_context_dpz(find(outp_dpz.p_context2_p<alpha3)),'ko','markersize',7,'markerfacecolor','m')
plot(find(outp_dpz.p_context2_n<alpha3),emp_atx.n_n_context_dpz(find(outp_dpz.p_context2_n<alpha3)),'ko','markersize',7,'markerfacecolor','m')
tp_editplots
