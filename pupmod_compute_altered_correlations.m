function emp = pupmod_compute_altered_correlations(cleandat,para)
% COMPUTE FRACTION OF SIGNIFICANTLY ALTERED CORRELATIONS
% --------------------------
% Input: combined FC data (NxNx28x3x2x17), with N = 400 or 76
% para.alpha: alpha-level for initial t-test (default: 0.05)
% para.freq: frequencies of interest (default: 1-17 - all)
